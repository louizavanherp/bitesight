...
<nav class=nav>
    ...
    <li class="nav__item nav__item--list"><a href="list.php"><img src="images/list.svg" alt="list" class="<?php if($parts[count($parts)-1] == "list.php") echo "current current--list"; ?>"></a></li>
